      ...
      <div className='container'>
        <div className='text-container'>
          <p>
            ...
            competitions in mechanics and mechanical constructions, I decided to enroll at the
            Faculty of Organization and Informatics in Varaždin. I earned my Bachelor's degree in
            September 2022 and graduated with honors (cum laude) with a Master's degree in
            Informatics in Education in 2024.
          </p>
          <p>
