      ...
      <div className='container'>
        <div className='text-container'>
          ...
          <p>
            ...
            tools. I also have 7 months of professional experience in frontend development where I
            primarily used Next.js, React and React Native. Other than frontend development, I'm
            also working on my backend skills primarily using Laravel.
          </p>
        </div>
